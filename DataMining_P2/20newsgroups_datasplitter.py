...
twenty_newsgroups = fetch_20newsgroups(subset='all', categories=None, shuffle=True)

print(twenty_newsgroups.target_names)
...
# training_length = int(count * 0.6)
# test_length = int(count * 0.4)
